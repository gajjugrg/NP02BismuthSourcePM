...
def process_directory(directory):
    ...
    file_path = glob.glob(os.path.join(directory, 'F2--*.txt'))[0]  # Dynamically find F1 files
    background_file_path = glob.glob(os.path.join(directory, 'F4--*.txt'))[0]  # Dynamically find F3 files
    ...
    print(f"Shoulder start detected at: {shoulder_start_voltage} mV")
    ...
    print(f"Gaussian mean: {x0_fit_corrected} mV")
